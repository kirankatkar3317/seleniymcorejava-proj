...
WebElement addbutton = driver.findElement(By.cssSelector("span[class='btn__text']"));
...
for(int i=0; i< stickerListNames.size(); i++ ) {
	...
	driver.findElements(By.xpath("//div//div//button")).get(i).click();
	//driver.findElement(By.xpath("//div//div//button")).click();
	
		driver.findElement(By.xpath("//i[@class='popup-cart__close ml-auto cursor-pointer']//*[name()='svg']")).click();
	wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("//div//div//button")));
	}
	else {
	i++;
	}
